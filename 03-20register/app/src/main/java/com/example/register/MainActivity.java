...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView(){
        ...
        nationBt.setOnClickListener(this);
    ...
    private void check(){
        ...
        if(passwordEt.getText().toString().length() < 6 || passwordEt.getText().toString().length() >= 18){
            ...
            Toast.makeText(MainActivity.this,"请输入6-18位密码！",Toast.LENGTH_LONG).show();
            i++;
        }
        ...
        if(hobbyBt.getText()=="请选择您的爱好！"){
            i++;
        }
        if(nationBt.getText()=="请选择您的籍贯！"){
            i++;
        }
    }
    private void reset(){
    ...
    int which_a;
    private void error(){
        Toast.makeText(MainActivity.this,"请完善您的信息！",Toast.LENGTH_LONG).show();
    }
    @Override
