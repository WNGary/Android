...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    private int i;
    private List i_2;
    private Button hobbyBt, nationBt, enterBt, cancelBt, ReturnBackBT;
    ...
    private void initView(){
        ...
        ReturnBackBT = (Button)findViewById(R.id.ReturnBack);
        ...
        ReturnBackBT.setOnClickListener((View.OnClickListener)this);
    }
    private void check(){
        i = 0;
    ...
    private void OutPut(){
        ...
        if (i!=0){
            ...
            editor.putString(userIdEt.getText().toString(),userIdEt.getText().toString());
            editor.putString(userIdEt.getText().toString()+"password",passwordEt.getText().toString());
            editor.commit();
            Intent intent = new Intent();
            intent.setClass(RegisterActivity.this,RegisterSuccessfulActivity.class);
            intent.putExtra("RegisterData",listRegister);
